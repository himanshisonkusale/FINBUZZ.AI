...
              >
                <div className={`w-24 h-24 bg-gradient-to-r ${member.bg} rounded-full mx-auto mb-4 border border-charcoal-600/40 group-hover:border-orange-400/60 transition-all duration-500 group-hover:scale-125 shadow-glow-sm group-hover:shadow-orange`} />
