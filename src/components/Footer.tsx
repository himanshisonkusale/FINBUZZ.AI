  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 animate-fadeInUp">
          ...
          <div className="transform hover:scale-105 transition-transform duration-500 animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
            ...
            <ul className="space-y-2 animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
              {['Powerful Features', 'How to Use', 'Documentations', 'About'].map((link) => (
                <li key={link}>
                  <a href="#" className="text-text-muted hover:text-text-primary hover:text-electric-blue-400 transition-all duration-300 transform hover:translate-x-2">
                    {link}
                  </a>
                </li>
              ))}
        ...
        {/* Bottom Bar */}
        <div className="border-t border-electric-blue-900/40 mt-8 pt-8 flex flex-col md:flex-row justify-center items-center animate-fadeInUp" style={{ animationDelay: '1.2s' }}>
